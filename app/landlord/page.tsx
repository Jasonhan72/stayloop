...
const CFG: RoleLandingConfig = {
  ...
  color: '#047857',
  h1: {
    zh: <>是流水线,不是收件箱。<br />Logic 替你读懂每份申请。</>,
    en: <>A pipeline, not an inbox.<br />Logic reads every application for you.</>,
  },
  sub: {
  ...
  journey: [
    { h: { zh: '发布 / 迁入房源', en: 'List or import a property' }, b: { zh: 'Logic 4 分钟从旧平台迁入并重做房源。', en: 'Logic imports and rebuilds your listing from old platforms in 4 minutes.' } },
  ...
  scenario: {
    ...
    after: { zh: 'Logic 4 分钟重做房源、跑完尽调,关键时刻她只按「同意」。', en: 'Logic rebuilt the listing and ran due diligence in 4 minutes; at the key moment she just hits "approve."' },
