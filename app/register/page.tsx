          ...
          <div className="sl-card p-8 sm:p-10">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-[10px] border border-line-strong bg-white px-4 py-[11px] text-[13.5px] font-semibold transition hover:border-body-3 hover:bg-surface-chip"
              >
                <GoogleIcon />
                Google
              </button>
