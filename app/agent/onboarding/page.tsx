...
const STEPS = [
  ...
  },
  {
    ...
    desc: { zh: '区域、客单价、是否拍照 / 写作配套。Brief 按这些来分配任务。', en: 'Area, deal size, whether you offer photo / copywriting add-ons. Brief assigns tasks accordingly.' },
    fields: [
...
const PERKS = [
  ...
  { zh: 'Brief AI 帮你写 listing / brief 包 / OREA 表', en: 'Brief AI drafts your listings / brief packs / OREA forms' },
            ...
            <div className="grid items-center gap-10 lg:grid-cols-[1.4fr_1fr]">
              <div>
                ...
                <p className="mt-5 max-w-[560px] text-[16px] leading-relaxed text-body-2">
                  {zh
                    ? 'Brief 是你的 AI copilot — 它接客户、配房源、写 brief、起草约 ;你做的是面对面的判断。已通过 Tier 验证的客户直接进你 inbox。'
                    : 'Brief is your AI copilot — it takes clients, matches listings, writes briefs and drafts leases; you make the face-to-face calls. Tier-verified clients land straight in your inbox.'}
                </p>
                <div className="mt-7 flex flex-wrap gap-3">
                  ...
                  <Link href="/agent/agent" className="sl-btn-secondary !py-[12px]">
                    {zh ? '先看 Brief 工作台' : 'Preview the Brief workspace'}
                  </Link>
                </div>
              </div>
          ...
          <div className="mx-auto flex max-w-[1320px] flex-wrap items-center justify-between gap-6 px-6 py-12 sm:px-8 lg:px-12">
            <div>
              ...
              <p className="mt-1 text-[13.5px] text-body-2">
                {zh ? '我们 1 个工作日内回复。审核期间 Brief 工作台只读权限已为你开通。' : 'We reply within one business day. Read-only access to the Brief workspace is enabled for you during review.'}
              </p>
            </div>
