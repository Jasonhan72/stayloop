'use client'
// -----------------------------------------------------------------------------
// /tenant-screening — AI Tenant Screening deep landing
// -----------------------------------------------------------------------------
// This was the V4.1 homepage. As of 2026-05-08 the homepage covers the
// full Stayloop rental platform; the screening-specific deep marketing
// lives here under /tenant-screening so prospects who arrive from
// screening-focused outbound (ads, decks, emails) land on the right pitch.
//
// Sections, top → bottom:
