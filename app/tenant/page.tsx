...
const CFG: RoleLandingConfig = {
  ...
  color: '#7C3AED',
  h1: {
    zh: <>说出你想要的家,<br />AI Agent 替你办到签约。</>,
    en: <>Describe the home you want,<br />AI Agent gets you to signing.</>,
  },
  sub: {
    zh: '验证一次,处处通行。AI Agent 替你找房、比价、约看、一键申请,资料只在你点头时才分享。每个关键决定,依然由你拍板。',
    en: 'Verify once, apply everywhere. AI Agent finds listings, compares prices, books showings and applies in one tap — your data is shared only when you say yes. Every key decision stays with you.',
  },
  primaryCta: { label: { zh: '90 秒身份验证 →', en: '90-second ID check →' }, href: '/onboarding/welcome', authedHref: '/tenant/agent' },
  ...
  journey: [
    { h: { zh: '为 AI 起名', en: 'Name your AI' }, b: { zh: '任何你喜欢的名字。从此 TA 只为你。', en: 'Any name you like. From now on it works only for you.' } },
    ...
    { h: { zh: '浏览房源', en: 'Browse listings' }, b: { zh: '地图加卡片,AI Agent 主动按你的需求筛过。', en: 'Map and cards, pre-filtered by AI Agent to match what you want.' } },
    ...
    { h: { zh: '入住安心长住', en: 'Settle in for the long term' }, b: { zh: '缴租维修续约退租,AI Agent 全程替你照看。', en: 'Rent, repairs, renewals and move-out — AI Agent looks after it all.' } },
  ],
  scenario: {
    name: 'Mia Chen',
    ...
    after: { zh: 'AI Agent 90 秒验明身份,中文读懂租约,35 分钟签约入住。', en: 'AI Agent verified her ID in 90 seconds, explained the lease in Chinese, and got her signed in 35 minutes.' },
