...
export function IdeasPage({ role }: { role: AgentRole }) {
  ...
  return (
    <WorkspaceShell role={role} hideAside>
      ...
      {/* The recommendation cards left the web assistant page (Muse web layout, 2026-09-25) and live here. */}
      {data.recommendations.length > 0 && <div className="mt-6"><RecommendationDeck items={data.recommendations} /></div>}
    </WorkspaceShell>
  )
}
