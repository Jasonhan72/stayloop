...
export const DICT = {
  ...
  'nav.services': { en: 'Provider', zh: '服务商' },
  ...
  'foot.services': { en: 'Repairs & services network', zh: '维修与服务网络' },
  ...
  // Screen page
  'screen.title': { en: 'Stayloop Screening', zh: 'Stayloop 租客筛查' },
  ...
  'screen.tier.pro.sources': { en: 'CanLII + Ontario Courts + Verified Network', zh: 'CanLII + 安省法院门户 + 核验网络' },
  ...
  'screen.form.name.hint': {
    ...
    zh: '未填写时，系统从证件、在职信或工资单中自动提取姓名，用于法庭记录查询',
  },
  ...
  'screen.result.footer.dataSourcePro': { en: ' + Ontario Courts Portal', zh: ' + 安省法院门户' },
  ...
  'screen.drop.sub': {
    ...
    zh: '支持 PDF、JPG、PNG、HEIC——在职信、工资单、银行流水、证件、征信报告等 · 单个文件 ≤ 25 MB（大照片会自动压缩）',
  },
  'screen.drop.pick': { en: '📎 Choose files', zh: '📎 选择文件' },
  'screen.filetype.employment': { en: 'Employment Letter', zh: '在职信' },
  'screen.filetype.paystub': { en: 'Pay Stubs', zh: '工资单' },
  'screen.filetype.bank': { en: 'Bank Statements', zh: '银行流水' },
  'screen.filetype.id': { en: 'ID / Passport', zh: '证件 / 护照' },
  'screen.filetype.credit': { en: 'Credit Report', zh: '征信报告' },
  'screen.filetype.offer': { en: 'Offer / Study Permit', zh: '录用信 / 学签' },
  'screen.filetype.reference': { en: 'Landlord Reference', zh: '房东推荐信' },
  'screen.filetype.other': { en: 'Other Documents', zh: '其他文件' },
  ...
  'screen.files.auto.sources.pro': { en: 'and query CanLII + Ontario Courts + Verified Network automatically', zh: '自动查询 CanLII、安省法院门户与 Stayloop 核验网络——全程自动' },
  ...
  'screen.result.court.source.canliiScc': { en: 'CanLII — Ontario Small Claims Court', zh: 'CanLII — 安省小额法庭' },
  'screen.result.court.source.ontarioCourts': { en: 'Ontario Courts Public Portal — civil suits', zh: '安省法院公开门户 — 民事诉讼' },
