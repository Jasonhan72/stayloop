    ...
    pending: [
      {
        ...
        summary: 'Luna 为 Unit 1207 · King West 的房东 Sarah Wang 准备了一份租赁 Passport 摘要 —— 只在你点头后才会发送。',
        recipient_label: 'Sarah Wang · Unit 1207 房东',
        data_scope: ['就业状态', '收入区间', '租赁就绪分', '推荐人状态'],
        excluded_data: ['原始证件', '完整银行流水', '私人备注'],
        risk_level: 'medium',
        expires_at: null,
        metadata: { property_id: 'unit_1207_king_west', prepared_by: 'Luna' },
      },
    ],
    result: {
    ...
    pending: [
      {
        ...
        summary: 'Sarah Wang 派了一单。客户 Mia Chen (认证 2 级) · $80 已 Stripe 预授权。90 秒决定接不接。下面是 RECO 合规命脉：你被授权 / 不被授权回答的问题清单。',
        ...
        risk_level: 'low',
        expires_at: null,
        metadata: { client: 'Mia Chen', listing: 'Unit 1207 · King West', fee: '$80', landlord: 'Sarah Wang' },
      },
    ],
    result: {
      title: '今天 5 场带看 · $480 已锁 · 区域排名 #3 (GTA West · 23 经纪)',
      body: '14:00 带 Mia Chen 看 King West Unit 1207 ($80)· Carter Court 4F ($60, 已 Check-in)· 87 Niagara Loft ($90, 已确认)。每场都标了你被授权与未授权回答的问题清单。',
    },
  },
}
