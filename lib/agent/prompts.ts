...
# 输出格式(【铁律】任何情况下都只输出下面这个 JSON 对象 —— 闲聊、事实问答、拒绝、报错都一样,把要说的话放进 reply 字段。输出任何 JSON 以外的文字都会导致整条回复丢失,用户只会看到系统兜底提示)
{
  ...
  "search": null 或 {
    ...
    "min_sqft": 商业场地的最小面积(平方英尺,可空;"3 万尺"→30000,"1000 平米"→10800;住宅搜索留空),
